...
export function PageLayout({ actions, children }: PageLayoutProps) {
  return (
    <div className="flex min-h-dvh flex-col">
      <header className="sticky top-0 z-20 flex h-[60px] shrink-0 items-center justify-between gap-4 border-b-[3px] border-ink bg-white px-4 tablet:h-[72px] tablet:px-10">
        <h1>
