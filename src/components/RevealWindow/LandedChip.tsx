...
// hover — the mouse, or keyboard focus, never a tap.
export function LandedChip({ name, expanded, onPreview, onPreviewEnd, onClick }: LandedChipProps) {
  return (
    <button
      type="button"
      aria-expanded={expanded}
      className="cursor-pointer outline-none focus-visible:outline-[3px] focus-visible:outline-offset-2 focus-visible:outline-ink"
      onClick={onClick}
