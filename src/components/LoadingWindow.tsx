...
export function LoadingWindow() {
  ...
  return (
    <main className="mx-auto w-full max-w-[366px] px-5 py-10 tablet:max-w-[420px]">
      <Window title="loading">
        <div role="status" className="flex min-h-[150px] flex-col items-center justify-center gap-6">
          <PixelProgressBar />
