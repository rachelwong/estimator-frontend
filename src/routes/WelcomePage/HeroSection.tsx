...
// window on a sample Session, opened on its crowded Square so the popover is
...
//
// The hero line stays an h2: the lockup is every screen's h1, and swapping that
// is Stage 10's one pass across all of them.
  ...
  return (
    <div className="bg-page-top pb-16 tablet:pb-24">
      ...
      >
        ...
        <h2 className="max-w-[1000px] font-display text-[36px] leading-none text-ink tablet:text-[58px] desktop:text-[78px]">
          Teams who estimate together
          <br />
        ...
        <p className="max-w-[600px] text-[18px] leading-[1.5] text-text-muted tablet:text-[21px]">
          A live estimation board for dev teams. Share a link, everyone picks a Square on a Time ×
          Resources grid in private, then the Reveal shows where you all landed.
        </p>
        ...
        <div className="flex w-full flex-col gap-4 pt-1.5 tablet:w-auto tablet:flex-row">
          ...
          <Button asChild variant="secondary" className="h-[52px] font-display text-[14px] font-normal">
